...
async function seed() {
  ...
  const [v1] = await db.insert(venuesTable).values({ userId: uv1.id, name: "The Blue Note", address: "321 Jazz Ave, Toronto, ON", description: "A beloved jazz club with cozy booths and a world-class sound system.", size: "sm", moods: ["Intimate", "Chill", "Bar"], imageUrls: ["https://images.unsplash.com/photo-1514525253440-b393452e8d26?w=800&q=80", "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=800&q=80"], lat: 43.6532, lng: -79.3832 }).returning();
  const [v2] = await db.insert(venuesTable).values({ userId: uv2.id, name: "Rooftop Live", address: "88 King St W, Toronto, ON", description: "An open-air rooftop venue with stunning city views and a lively crowd.", size: "md", moods: ["Rooftop", "Outdoor", "High-energy", "All-ages"], imageUrls: ["https://images.unsplash.com/photo-1566737236500-c8ac43014a67?w=800&q=80", "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=800&q=80", "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=800&q=80"], lat: 43.6487, lng: -79.3816 }).returning();
  const [v3] = await db.insert(venuesTable).values({ userId: uv3.id, name: "The Hideaway Lounge", address: "47 Queen St E, Toronto, ON", description: "A hidden gem basement bar with velvet curtains and warm lighting.", size: "xs", moods: ["Lounge", "Formal", "Intimate"], imageUrls: ["https://images.unsplash.com/photo-1543007631-283050bb3e8c?w=800&q=80"], lat: 43.6506, lng: -79.3789 }).returning();
